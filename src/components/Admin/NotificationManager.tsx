            ...
            {notifications.map((notification) => (
              <div
                ...
                className={`p-4 border rounded-lg ${
                  notification.isActive ? 'border-green-200 bg-green-50' : 'border-gray-200 bg-gray-50'
                }`}
              >
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                  <div className="flex-1">
                    <div className="flex items-center space-x-2 mb-2">
                      ...
                      <span className={`px-2 py-1 text-xs rounded-full ${
                        notification.isActive ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-600'
                      }`}>
                  ...
                  <div className="flex flex-row sm:flex-col space-x-2 sm:space-x-0 sm:space-y-2">
                    <button
                      ...
                      className="flex items-center space-x-1 px-3 py-1 text-blue-600 hover:bg-blue-50 rounded text-sm transition-colors"
                    >
                      <Edit2 size={14} />
                      <span>Edit</span>
                    </button>
