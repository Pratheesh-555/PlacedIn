...
const Footer: React.FC = () => {
  ...
  const teamMembers = [
    ...
    },
    {
      ...
      avatar: "https://media.licdn.com/dms/image/v2/D5603AQEq_iL7XtM8nw/profile-displayphoto-shrink_800_800/B56ZZwR4OTHsAc-/0/1745640458660?e=1762992000&v=beta&t=n1rSNRGti1YgzupOwQ8Y9oRS57_Bfe4tfb1U3bIVUlE"
    }
  ];

  return (
    <footer className="bg-blue-100 dark:bg-gray-800 border-t border-blue-200 dark:border-gray-700 py-4 mt-8 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <div className="flex items-center justify-center space-x-2 mb-2 relative select-none">
            ...
            <AnimatedHeart />
            <span className="text-gray-600 dark:text-gray-300 text-sm">by the PlacedIn Team</span>
          </div>

          {/* Copyright section */}
          <div className="text-gray-500 dark:text-gray-400 text-sm mb-3">
            © {currentYear} <button 
              className="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 font-semibold transition-colors cursor-pointer underline"
          ...
          {/* Additional info */}
          <div className="text-gray-400 dark:text-gray-500 text-xs max-w-md mx-auto">
          ...
          <div className="flex items-center justify-center space-x-6 mt-3 text-xs text-blue-700 dark:text-blue-400">
            <button className="hover:text-blue-900 dark:hover:text-blue-300 font-semibold transition-colors" onClick={() => setShowPrivacy(true)}>
              Privacy Policy
            </button>
            <span className="text-blue-300 dark:text-blue-600">•</span>
            <button className="hover:text-blue-900 dark:hover:text-blue-300 font-semibold transition-colors" onClick={() => setShowTerms(true)}>
              Terms of Service
            </button>
            <span className="text-blue-300 dark:text-blue-600">•</span>
            <button
              className="hover:text-blue-900 dark:hover:text-blue-300 font-semibold transition-colors"
          ...
          {showPrivacy && (
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg max-w-lg w-full p-6 relative">
                <button className="absolute top-2 right-2 text-gray-400 dark:text-gray-500 hover:text-blue-600 dark:hover:text-blue-400 text-xl" onClick={() => setShowPrivacy(false)}>&times;</button>
                <div className="overflow-y-auto max-h-[70vh] text-left">
                  <h2 className="text-xl font-bold mb-2 text-blue-700 dark:text-blue-400">Privacy Policy</h2>
                  <p className="mb-2 text-gray-700 dark:text-gray-300">PlacedIn is committed to protecting your privacy. This policy outlines how we collect, use, and safeguard your information.</p>
                  <ul className="list-disc pl-5 mb-4 text-sm text-gray-700 dark:text-gray-300">
                    ...
                    <li><strong>User Rights:</strong> You can request removal of your data by contacting us at <a href="mailto:pratheeshkrishnan595@gmail.com" className="text-blue-600 dark:text-blue-400 underline">our support team</a>.</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          {showTerms && (
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg max-w-lg w-full p-6 relative">
                <button className="absolute top-2 right-2 text-gray-400 dark:text-gray-500 hover:text-blue-600 dark:hover:text-blue-400 text-xl" onClick={() => setShowTerms(false)}>&times;</button>
                <div className="overflow-y-auto max-h-[70vh] text-left">
                  <h2 className="text-xl font-bold mb-2 text-blue-700 dark:text-blue-400">Terms of Service</h2>
                  <p className="mb-2 text-gray-700 dark:text-gray-300">By accessing or using PlacedIn, you agree to the following terms:</p>
                  <ul className="list-disc pl-5 mb-4 text-sm text-gray-700 dark:text-gray-300">
          ...
          {showTeam && (
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg max-w-md w-full p-6 relative">
                <button className="absolute top-2 right-2 text-gray-400 dark:text-gray-500 hover:text-blue-600 dark:hover:text-blue-400 text-xl" onClick={() => setShowTeam(false)}>&times;</button>
                <div className="text-center">
                  <h2 className="text-xl font-bold mb-4 text-blue-700 dark:text-blue-400">Meet Our Team</h2>
                  <p className="text-gray-600 dark:text-gray-300 text-sm mb-6">Connect with the developers behind PlacedIn</p>
                  
                  <div className="space-y-4">
                    {teamMembers.map((member, index) => (
                      <div key={index} className="flex items-center space-x-4 p-3 rounded-lg hover:bg-blue-50 dark:hover:bg-gray-700 transition-colors">
                        <img 
                          src={member.avatar} 
                          alt={member.name}
                        ...
                        <button
                          ...
                          className="bg-blue-600 dark:bg-blue-500 hover:bg-blue-700 dark:hover:bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors flex items-center space-x-2"
                        >
